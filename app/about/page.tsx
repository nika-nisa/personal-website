export default function AboutPage() {
    return (
        <main className="min-h-screen flex flex-col items-center justify-center p-4 font-mono">
            <h1 className="hover:text-4xl transition-all duration-300 text-3xl mb-2">about</h1>
            <p className="max-w-xl text-center text-lg mb-6"> Hi! I'm Anika, a hobbyist UX designer that's into computational biology. </p>

            <h2 className="text-2xl mb-2">Skills & Expertise</h2>
            ...
            <h2 className="text-2xl mb-2 mx-auto px-6">My Vision</h2>
            <p className="mb-2 mx-auto px-25">
                I'm driven by my love for elegant design systems and technological solutions that bridge biology and computation!
            </p>

            <p className="mx-auto mb-6 px-50">
